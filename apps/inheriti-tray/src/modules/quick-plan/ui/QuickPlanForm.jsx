...
export function QuickPlanForm({ messages, state, form, setForm, onReview, onCancel, error, preparing }) {
  ...
  return <form id="capture" onSubmit={onReview}>
    ...
    />
    {form.audience === 'team' && <SelectField
    ...
    />
    {definition && (isMedia(definition.id)
      ? <div className="field">
    ...
    <div className="buttons">
      ...
      <button type="submit" disabled={preparing}>{messages.review}</button>
    </div>
  </form>;
}

...
const mock = vi.hoisted(() => ({
  ...
  list: vi.fn(), context: vi.fn(), start: vi.fn(), add: vi.fn(), abort: vi.fn(), recover: vi.fn(), discard: vi.fn(), discardLocal: vi.fn(),
}));
...
vi.mock('@safetech/inheriti-elements-core/node', () => ({
  createPlanEditOperations: () => ({ list: mock.list, context: mock.context, start: mock.start, add: mock.add, abort: mock.abort, recover: mock.recover, discard: mock.discard, discardLocal: mock.discardLocal }),
}));
